<template>
  <div class="container">
    ...
    <Modal v-model="modal1" title="新添书籍" width="800" scrollable="true" ok-text="添加" @on-ok="ok('formItem2')">
      <Form ref="formItem2" :model="formItem2" :rules="ruleItem2" :label-width="80">
        ...
        <FormItem label="描述" prop="descri">
          <quill-editor v-model="formItem2.descri" ref="VueQuillEditor" :content="content"
            @change="onEditorChange($event)"></quill-editor>
        </FormItem>
      </Form>
    </Modal>

    <Modal v-model="modal2" title="新添书籍副本" ok-text="添加副本" @on-ok="ok2('formItem3')">
